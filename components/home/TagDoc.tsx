...
const TagDoc = ({ collectionEl, size }) => {
    ...
    return (
        <>
            <Tag size={size} border='2px' borderColor={'black'} colorScheme='gray' variant="subtle">
                <TagLabel>
                ...
                <AiOutlineLink />
                <TagCloseButton style={{ cursor: 'pointer' }} onClick={() => handleCloseCollection(collectionEl.collectionId)} />
            </Tag></>
    )
